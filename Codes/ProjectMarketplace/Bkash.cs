...
namespace Project_Marketplace
{
    public partial class Bkash : Form
    {
        ...
        {
            connect.Open();
            string query = "select * from BkashTbl";
        ...
        private void ConfirmbksBtn_Click(object sender, EventArgs e)
        {
            string mobileNumber = bksnmbrTxt.Text.Trim();
            string bkashPin = bksPinTxt.Text.Trim();
        ...
        private bool bkashInfo()
        {
            ...
            {
                connect.Open();
                string query = "INSERT INTO BkashTbl (BkashNum, BkashPass) VALUES (@BkashNum, @BkashPass)";
                SqlCommand cmd = new SqlCommand(query, connect);
                cmd.Parameters.AddWithValue("@BkashNum", bksnmbrTxt.Text);
                cmd.Parameters.AddWithValue("@BkashPass", bksPinTxt.Text);
